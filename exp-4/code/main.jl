...
frequencies = [300, 450, 650, 900, 1300, 1800, 2500, 3500, 5000]
trialtimes = [10, 35, 60, 85, 110, 135, 160, 185, 210]
P3DataSets = [Dict("EffectiveArea" => [], "EAErr" => [], "T60" => [], "T60Err" => [], "Magnitude" => [], "Time" => []) for _ in 1:3]

for trial in 1:3
    y, fs = load(DataDir * "processed/Exp4-P3-T$trial.wav")
    fs = Int(fs)
    y = y .+ eps()
    for i in 1:9
        PeakMags, times = GetMagnitudes(trialtimes[i] * fs, fs, y, window=300)
        AvgMaxDist = mean(abs.(PeakMags .- PeakMags[1])) - std(abs.(PeakMags .- PeakMags[1]))
        i_ = findfirst(x -> abs(PeakMags[x] - PeakMags[1]) > AvgMaxDist, 1:length(PeakMags))
        Y = PeakMags[1:i_]
        X = times[1:i_]
        model(x, p) = p[1] * x .+ p[2]
        p0 = [1.0, 0.0]
        ...
        EA = effective_area(T60, V_room)
        EAErr = EA * T60Error / T60
        push!(P3DataSets[trial]["Magnitude"], PeakMags)
        push!(P3DataSets[trial]["Time"], times)
        push!(P3DataSets[trial]["T60"], T60)
        push!(P3DataSets[trial]["T60Err"], T60Error)
        push!(P3DataSets[trial]["EffectiveArea"], EA)
        push!(P3DataSets[trial]["EAErr"], EAErr)
    end
end
############################################## Exprience 4 Part 4 ##############################################
frequencies = [300, 450, 650, 900, 1300, 1800, 2500, 3500, 5000]
trialtimes = [10, 35, 60, 85, 110, 135, 160, 185, 210]
P4DataSets = [Dict("EffectiveArea" => [], "EAErr" => [], "T60" => [], "T60Err" => [], "Magnitude" => [], "Time" => []) for _ in 1:3]

for trial in 1:3
    y, fs = load(DataDir * "processed/Exp4-P4-T$trial.wav")
    fs = Int(fs)
    y = y .+ eps()
    for i in 1:9
        PeakMags, times = GetMagnitudes(trialtimes[i] * fs, fs, y, window=300)
        ...
        EA = effective_area(T60, V_room)
        EAErr = EA * T60Error / T60
        push!(P4DataSets[trial]["Magnitude"], PeakMags)
        push!(P4DataSets[trial]["Time"], times)
        push!(P4DataSets[trial]["T60"], T60)
        push!(P4DataSets[trial]["T60Err"], T60Error)
        push!(P4DataSets[trial]["EffectiveArea"], EA)
        push!(P4DataSets[trial]["EAErr"], EAErr)
    end
end
...
Avgs3 = mean([P3DataSets[1]["T60"] P3DataSets[2]["T60"] P3DataSets[3]["T60"]], dims=2)
Err3 = mean([P3DataSets[1]["T60Err"] P3DataSets[2]["T60Err"] P3DataSets[3]["T60Err"]], dims=2)
Avgs4 = mean([P4DataSets[1]["T60"] P4DataSets[2]["T60"] P4DataSets[3]["T60"]], dims=2)
Err4 = mean([P4DataSets[1]["T60Err"] P4DataSets[2]["T60Err"] P4DataSets[3]["T60Err"]], dims=2)
...
plot(frequencies, Avgs3, c=:darkblue, label="Anechoic Chamber")
scatter!(frequencies, Avgs3, err=Err3, c=:blue, ls=:dash, msc=:darkblue, label=nothing, ms=3)
plot!(frequencies, Avgs4, c=:darkred, label="Reverberation Chamber")
scatter!(frequencies, Avgs4, err=Err4, c=:red, ls=:dash, msc=:darkred, label=nothing, ms=3)
plot!(title="Reverberation Time", xlabel="Frequency (Hz)", ylabel="T60 (s)",
    xticks=(frequencies, string.(frequencies)), xscale=:log2, yscale=:log10, legend=:left, size=(800, 600), frame=:box)
savefig(FiguresDir * "ReverberationTime-H.png")
...
Avgs3 = mean([P3DataSets[1]["EffectiveArea"] P3DataSets[2]["EffectiveArea"] P3DataSets[3]["EffectiveArea"]], dims=2)
Err3 = mean([P3DataSets[1]["EAErr"] P3DataSets[2]["EAErr"] P3DataSets[3]["EAErr"]], dims=2)
Avgs4 = mean([P4DataSets[1]["EffectiveArea"] P4DataSets[2]["EffectiveArea"] P4DataSets[3]["EffectiveArea"]], dims=2)
Err4 = mean([P4DataSets[1]["EAErr"] P4DataSets[2]["EAErr"] P4DataSets[3]["EAErr"]], dims=2)
...
plot!(title="Effective Area", xlabel="Frequency (Hz)", ylabel="Area (m²)",
    xticks=(frequencies, string.(frequencies)), xscale=:log2, yscale=:log10, legend=:left, size=(800, 600), frame=:box)
savefig(FiguresDir * "EffectiveArea-H.png")
...
T1Times = mean([P3DataSets[1]["Time"][1] P3DataSets[2]["Time"][1] P3DataSets[3]["Time"][1]], dims=2)
T1Mags = mean([P3DataSets[1]["Magnitude"][1] P3DataSets[2]["Magnitude"][1] P3DataSets[3]["Magnitude"][1]], dims=2)
# T2Times = mean([P3DataSets[1]["Time"][2] P3DataSets[2]["Time"][2] P3DataSets[3]["Time"][2]], dims=2)
# T2Mags = mean([P3DataSets[1]["Magnitude"][2] P3DataSets[2]["Magnitude"][2] P3DataSets[3]["Magnitude"][2]], dims=2)
# T3Times = mean([P3DataSets[1]["Time"][3] P3DataSets[2]["Time"][3] P3DataSets[3]["Time"][3]], dims=2)
# T3Mags = mean([P3DataSets[1]["Magnitude"][3] P3DataSets[2]["Magnitude"][3] P3DataSets[3]["Magnitude"][3]], dims=2)
# T4Times = mean([P3DataSets[1]["Time"][4] P3DataSets[2]["Time"][4] P3DataSets[3]["Time"][4]], dims=2)
# T4Mags = mean([P3DataSets[1]["Magnitude"][4] P3DataSets[2]["Magnitude"][4] P3DataSets[3]["Magnitude"][4]], dims=2)
# T5Times = mean([P3DataSets[1]["Time"][5] P3DataSets[2]["Time"][5] P3DataSets[3]["Time"][5]], dims=2)
# T5Mags = mean([P3DataSets[1]["Magnitude"][5] P3DataSets[2]["Magnitude"][5] P3DataSets[3]["Magnitude"][5]], dims=2)
# T6Times = mean([P3DataSets[1]["Time"][6] P3DataSets[2]["Time"][6] P3DataSets[3]["Time"][6]], dims=2)
# T6Mags = mean([P3DataSets[1]["Magnitude"][6] P3DataSets[2]["Magnitude"][6] P3DataSets[3]["Magnitude"][6]], dims=2)
# T7Times = mean([P3DataSets[1]["Time"][7] P3DataSets[2]["Time"][7] P3DataSets[3]["Time"][7]], dims=2)
# T7Mags = mean([P3DataSets[1]["Magnitude"][7] P3DataSets[2]["Magnitude"][7] P3DataSets[3]["Magnitude"][7]], dims=2)
# T8Times = mean([P3DataSets[1]["Time"][8] P3DataSets[2]["Time"][8] P3DataSets[3]["Time"][8]], dims=2)
# T8Mags = mean([P3DataSets[1]["Magnitude"][8] P3DataSets[2]["Magnitude"][8] P3DataSets[3]["Magnitude"][8]], dims=2)
T9Times = mean([P3DataSets[1]["Time"][9] P3DataSets[2]["Time"][9] P3DataSets[3]["Time"][9]], dims=2)
T9Mags = mean([P3DataSets[1]["Magnitude"][9] P3DataSets[2]["Magnitude"][9] P3DataSets[3]["Magnitude"][9]], dims=2)
...
plot!(T9Times[1:35] .- trialtimes[9], T9Mags[1:35], label="f = $(frequencies[9])Hz")
plot!(title="Anechoic Chamber, Magnitude Time Series", xlabel="Time (s)", ylabel="Magnitude (dB)", size=(800, 600), frame=:box)
savefig(FiguresDir * "Exp4-P3-Magnitude-Time-Series.png")

T1Times = mean([P4DataSets[1]["Time"][1] P4DataSets[2]["Time"][1] P4DataSets[3]["Time"][1]], dims=2)
T1Mags = mean([P4DataSets[1]["Magnitude"][1] P4DataSets[2]["Magnitude"][1] P4DataSets[3]["Magnitude"][1]], dims=2)
# T2Times = mean([P4DataSets[1]["Time"][2] P4DataSets[2]["Time"][2] P4DataSets[3]["Time"][2]], dims=2)
# T2Mags = mean([P4DataSets[1]["Magnitude"][2] P4DataSets[2]["Magnitude"][2] P4DataSets[3]["Magnitude"][2]], dims=2)
# T3Times = mean([P4DataSets[1]["Time"][3] P4DataSets[2]["Time"][3] P4DataSets[3]["Time"][3]], dims=2)
# T3Mags = mean([P4DataSets[1]["Magnitude"][3] P4DataSets[2]["Magnitude"][3] P4DataSets[3]["Magnitude"][3]], dims=2)
# T4Times = mean([P4DataSets[1]["Time"][4] P4DataSets[2]["Time"][4] P4DataSets[3]["Time"][4]], dims=2)
# T4Mags = mean([P4DataSets[1]["Magnitude"][4] P4DataSets[2]["Magnitude"][4] P4DataSets[3]["Magnitude"][4]], dims=2)
# T5Times = mean([P4DataSets[1]["Time"][5] P4DataSets[2]["Time"][5] P4DataSets[3]["Time"][5]], dims=2)
# T5Mags = mean([P4DataSets[1]["Magnitude"][5] P4DataSets[2]["Magnitude"][5] P4DataSets[3]["Magnitude"][5]], dims=2)
# T6Times = mean([P4DataSets[1]["Time"][6] P4DataSets[2]["Time"][6] P4DataSets[3]["Time"][6]], dims=2)
# T6Mags = mean([P4DataSets[1]["Magnitude"][6] P4DataSets[2]["Magnitude"][6] P4DataSets[3]["Magnitude"][6]], dims=2)
# T7Times = mean([P4DataSets[1]["Time"][7] P4DataSets[2]["Time"][7] P4DataSets[3]["Time"][7]], dims=2)
# T7Mags = mean([P4DataSets[1]["Magnitude"][7] P4DataSets[2]["Magnitude"][7] P4DataSets[3]["Magnitude"][7]], dims=2)
# T8Times = mean([P4DataSets[1]["Time"][8] P4DataSets[2]["Time"][8] P4DataSets[3]["Time"][8]], dims=2)
# T8Mags = mean([P4DataSets[1]["Magnitude"][8] P4DataSets[2]["Magnitude"][8] P4DataSets[3]["Magnitude"][8]], dims=2)
T9Times = mean([P4DataSets[1]["Time"][9] P4DataSets[2]["Time"][9] P4DataSets[3]["Time"][9]], dims=2)
T9Mags = mean([P4DataSets[1]["Magnitude"][9] P4DataSets[2]["Magnitude"][9] P4DataSets[3]["Magnitude"][9]], dims=2)

plot(T1Times[1:300] .- trialtimes[1], T1Mags[1:300], label="f = $(frequencies[1])Hz")
# plot!(T2Times[1:300] .- trialtimes[2][1:300], T2Mags, label="f = $(frequencies[2])Hz")
# plot!(T3Times[1:300] .- trialtimes[3][1:300], T3Mags, label="f = $(frequencies[3])Hz")
# plot!(T4Times[1:300] .- trialtimes[4][1:300], T4Mags, label="f = $(frequencies[4])Hz")
# plot!(T5Times[1:300] .- trialtimes[5][1:300], T5Mags, label="f = $(frequencies[5])Hz")
# plot!(T6Times[1:300] .- trialtimes[6][1:300], T6Mags, label="f = $(frequencies[6])Hz")
# plot!(T7Times[1:300] .- trialtimes[7][1:300], T7Mags, label="f = $(frequencies[7])Hz")
# plot!(T8Times[1:300] .- trialtimes[8][1:300], T8Mags, label="f = $(frequencies[8])Hz")
plot!(T9Times[1:300] .- trialtimes[9], T9Mags[1:300], label="f = $(frequencies[9])Hz")
plot!(title="Reverberation Chamber, Magnitude Time Series", xlabel="Time (s)", ylabel="Magnitude (dB)", size=(800, 600), frame=:box)
savefig(FiguresDir * "Exp4-P4-Magnitude-Time-Series.png")
...
# Part 3 Trial 1:
CSV.write(DataDir * "processed/Exp4-P3-T1.csv", DataFrame(Frequency=frequencies, T60=P3DataSets[1]["T60"], T60Err=P3DataSets[1]["T60Err"], EffectiveArea=P3DataSets[1]["EffectiveArea"], EAErr=P3DataSets[1]["EAErr"]))
# Part 3 Trial 2:
CSV.write(DataDir * "processed/Exp4-P3-T2.csv", DataFrame(Frequency=frequencies, T60=P3DataSets[2]["T60"], T60Err=P3DataSets[2]["T60Err"], EffectiveArea=P3DataSets[2]["EffectiveArea"], EAErr=P3DataSets[2]["EAErr"]))
# Part 3 Trial 3:
CSV.write(DataDir * "processed/Exp4-P3-T3.csv", DataFrame(Frequency=frequencies, T60=P3DataSets[3]["T60"], T60Err=P3DataSets[3]["T60Err"], EffectiveArea=P3DataSets[3]["EffectiveArea"], EAErr=P3DataSets[3]["EAErr"]))
# Part 4 Trial 1:
CSV.write(DataDir * "processed/Exp4-P4-T1.csv", DataFrame(Frequency=frequencies, T60=P4DataSets[1]["T60"], T60Err=P4DataSets[1]["T60Err"], EffectiveArea=P4DataSets[1]["EffectiveArea"], EAErr=P4DataSets[1]["EAErr"]))
# Part 4 Trial 2:
CSV.write(DataDir * "processed/Exp4-P4-T2.csv", DataFrame(Frequency=frequencies, T60=P4DataSets[2]["T60"], T60Err=P4DataSets[2]["T60Err"], EffectiveArea=P4DataSets[2]["EffectiveArea"], EAErr=P4DataSets[2]["EAErr"]))
# Part 4 Trial 3:
CSV.write(DataDir * "processed/Exp4-P4-T3.csv", DataFrame(Frequency=frequencies, T60=P4DataSets[3]["T60"], T60Err=P4DataSets[3]["T60Err"], EffectiveArea=P4DataSets[3]["EffectiveArea"], EAErr=P4DataSets[3]["EAErr"]))